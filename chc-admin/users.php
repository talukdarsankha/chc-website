        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <a class="btn btn-primary" href="javascript:void(0);" data-toggle="modal" data-target="#defaultModal">Add New User</a>
                        </div>
                        <div class="header ">
                            <h2>
                                USER DETAILS
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right js-sweetalert">
                                        <li><a href="javascript:void(0);" data-toggle="modal" data-target="#defaultModal">Add New User</a></li>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        <?php $readUsers = $crud->Read('users',"1 order by `id` desc");
                                        if ($readUsers) {
                                            $n=0;
                                        ...
                                        <tr>
                                            <td><?php echo ++$n; ?></td>
                                            <td><?php echo $readKey['name']." ".$readKey['surname']; ?></td>
                                            <td><?php echo $readKey['email']; ?></td>
                                            <td><?php echo $readKey['phone']; ?></td>
                                            <td><img src="<?php echo $readKey['user_image']; ?>" width="50px" height="50px"></td>
                                            <td><?php echo $readKey['user_type']; ?></td>
                                            <td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">Add A New User</h4>
                </div>
                    ...
                    <div class="row clearfix">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="fname" id="fname" class="form-control" placeholder="First Name" autofocus="false" required />
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="form-line">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="password" name="password" id="password" class="form-control" placeholder="Password" autofocus="false" required />
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="form-line">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <select name="userType" id="userType" class="form-control show-tick" required>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="file" class="form-control" name="image" accept="image/*"   id="upload-button" required />
                                    </div>
                                    <div class="col-md-8">
                ...
                <div class="modal-footer ">
                    ...
                    <input type="button" id="add-user" onclick="addUser(this);" class="btn btn-success waves-effect" value="Add User" data-type="success">
