...
//   } else {
    ...
    //   if (move_uploaded_file($_FILES["image"]["tmp_name"],"../".$target_file)) {
            ...
            // ministry_desc	
            // ministry_title	
            // ministry_date  ministryTitle  ministryDesc ministryDate
        ...
        $create = $crud->Create($data,"ministry_details");

        if($create) {
            $data['successMessage'] = "Ministry Details Added Successfully";
