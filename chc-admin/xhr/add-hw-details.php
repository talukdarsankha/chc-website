...
//   } else {
    ...
    //   if (move_uploaded_file($_FILES["image"]["tmp_name"],"../".$target_file)) {
        ...
        $data = [ 
          'hw_details_intro'=>$hwIntro,
          'hw_details_title'=>$hwTitle,
          'hw_details_desc'=>$hwDesc,
      
        ];

        $create = $crud->Create($data,"hw_details");

        if($create) {
            $data['successMessage'] = "Worship Details Added Successfully";
