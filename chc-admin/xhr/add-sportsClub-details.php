...
//   } else {
    ...
    //   if (move_uploaded_file($_FILES["image"]["tmp_name"],"../".$target_file)) {
        ...
        $data = [ 
          'sports_club_intro'=>$clubIntro,  
          'sports_club_title'=>$clubTitle,   

          'sports_club_desc'=>$clubDesc
         
        ];

        $create = $crud->Create($data,"sports_club_details");

        if($create) {
            $data['successMessage'] = "Club Details Added Successfully";
