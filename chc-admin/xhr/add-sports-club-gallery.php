...
//     exit();
//   } else {
    $target_dir = "images/sportsClubGallery/";
    ...
    if ($uploadOk == 0) {
      ...
      if (move_uploaded_file($_FILES["image"]["tmp_name"],"../".$target_file)) {
        $data = [
          'club_gallery_title'=>$galleryTitle,   
          'club_gallery_about'=>$galleryAbout,
          
          'club_gallery_img'=>$target_file
        ];
            ...
            // club_gallery_about
            // club_gallery_img
        $create = $crud->Create($data,"sports_club_gallery");

        if($create) {
            $data['successMessage'] = " Successfully Added to Sports Club";
