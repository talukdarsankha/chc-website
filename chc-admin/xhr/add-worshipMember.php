...
//     exit();
//   } else {
    $target_dir = "images/worshipMembers/";  
      ...
      if (move_uploaded_file($_FILES["image"]["tmp_name"],"../".$target_file)) {
        $data = [
          ...
          'member_about'=>$memberAbout
                ...
                // Full texts    memberName memberEmail memberPhone memberRole memberAbout
                // member_id
                // member_name
                // member_email
                // member_phone
                ...
                // member_photo
                // member_about
        $create = $crud->Create($data,"harvest_worship_members");

        if($create) {
            $data['successMessage'] = "Harvest Member Added Successfully";
