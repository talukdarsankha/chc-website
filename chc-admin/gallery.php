...
<body class="theme-red">
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <?php 
                                            $posterId= $readKey['img_posted_user_id']; 
    ...
    <!-- ADD GALLERY MODAL END -->
        ...
        <div class="modal fade" id="defaultModal2" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="defaultModalLabel">Post multiple gallery images</h4>
                    </div>
                    <form method="post" enctype="multipart/form-data">
                        <div class="modal-body">
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="photoTitle" id="multiPhotoTitle" class="form-control"
                                                placeholder="Title" autofocus="false" required />
                                        </div>
                                    </div>
                                    ...
                                    <!-- photo Description Textarea start -->
                                    <div class="form-floating " style="margin-bottom: 20px;">
                                        <label for="floatingTextarea2">Pictures Descprition</label>
                                        <textarea class="form-control" name="photoDesc" id="multiPhotoDesc" placeholder="Your image descprition here" style="height: 100px" required></textarea>
                                    </div>
                                    <!-- photo Description Textarea end -->  
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <p><b>Select Multiple Photo</b></p>
                                                <input type="file" class="form-control" name="images[]" accept="image/*"
                                                    id="multiImages" multiple />
                                            </div>
                                            <div class="col-md-8">
                                                <figure class="image-container">
                                                    <img id="chosen-image" class="image-style">
                        ...
                        <input type="hidden" value="<?php echo $_SESSION['this_user_id'] ?>" id="posted_userId">
    
    
                        <div class="modal-footer ">
                            <p id="multiFileMessage" style="color:red"></p>
                            <!-- use ajax to add user: xhr/add-user -->
                            <input type="button" id="addMultiPic" class="btn btn-success waves-effect"
                                value="Upload Photo" data-type="success">
                            <input type="button" id="add-user-dummy" class="btn btn-success waves-effect"
                                value="Loading. Please Wait...">
                            <button type="button" class="btn btn-danger waves-effect" data-dismiss="modal">CLOSE</button>
    ...
    <script>
        ...
        $(function(){
            $('#addMultiPic').click(function(event){
                // alert("SA");
                var files=$('#multiImages')[0].files;
                var title=$('#multiPhotoTitle').val();
                var desc=$('#multiPhotoDesc').val();
                var posterId=$('#posted_userId').val();
                // alert(files);
                console.log(files,title,desc,posterId);
                if(!files.length || !title || !desc || !posterId){
                    $("#multiFileMessage").html("Fill all the details to continue...");
