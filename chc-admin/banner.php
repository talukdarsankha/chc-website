                    ...
                    <div class="card">
                        <div class="header">
                            <a class="btn btn-primary" href="javascript:void(0);" data-toggle="modal"
                                data-target="#defaultModal">Add New Banner</a>
                        </div>
                        <div class="header ">
                            <h2>
                                BANNER DETAILS
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right js-sweetalert">
                                        <li><a href="javascript:void(0);" data-toggle="modal"
                                                data-target="#defaultModal">Add New Banner</a></li>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        <?php $readBanners = $crud->Read('banner',"1 order by `banner_id` desc"); 
                                        if ($readBanners) {
                                            $n=0;
                                            foreach($readBanners as $readKey){
                                              ?>
                                        <!-- 
                                            banner_id
                                            banner_img	
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo $readKey['banner_title']; ?>
                                            </td>
                                            <td>
                                                <?php echo $readKey['banner_desc']; ?>
                                            </td>
                                        
                                            <td><img src="<?php echo $readKey['banner_img']; ?>" width="250px"
                                                    height="150px">
                                             </td>
                                            

                                            <td><button id="edit-user" data-toggle="modal" data-target="#editModal"
                                                    data-id="<?php echo $readKey['banner_id']; ?>" type="button"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">Add A New Banner</h4>
                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="bannerTitle" id="bannerTitle" class="form-control"
                                            placeholder="Banner Title" autofocus="false" required />
                                    </div>
                                </div>
<!--                                 
                                <div class="form-group">
                                ...
                                <div class="form-floating " style="margin-bottom: 20px;">
                                    <label for="floatingTextarea2">Banner Descprition</label>
                                    <textarea class="form-control" name="bannerDesc" id="bannerDesc" placeholder="Leave your banner descprition here" style="height: 100px" required></textarea>
                                </div>
                                ...
                                <!-- <div class="form-group mb-3 ">
                                    <div class="form-line">
                                        <input type="text" name="sermonLink" id="sermonLink" class="form-control"
                                            placeholder="Youtube Link" autofocus="false" required />
                                    </div>
                                </div> -->
                    ...
                    <div class="modal-footer ">
                        ...
                        <input type="button" id="add-user" onclick="addUser(this);" class="btn btn-success waves-effect"
                            value="Add Banner" data-type="success">
            ...
            <div class="modal-content">
                ...
                <form method="post" enctype="multipart/form-data" action="">
                    <div class="modal-body">
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                ...
                                <!-- Banner Description Textarea start -->
                                <div class="form-floating " style="margin-bottom: 20px;">
                                    <label for="floatingTextarea2">Banner Descprition</label>
                                    <textarea class="form-control" id="edit_banner_desc" placeholder="Leave a descprition here" style="height: 100px" required></textarea>
                                </div>
                                <!-- Banner Description Textarea end -->
                    ...
                    <div class="modal-footer ">
                        ...
                        <!-- use ajax to add user: xhr/add-user -->
                        <input type="button" id="update-banner" class="btn btn-success waves-effect"
                            value="Update Banner">
                        <input type="button" id="delete-banner" class="btn btn-danger waves-effect"
                            value="Delete Banner">
                    </div>
    ...
    <script>
        $(function () {
            $('#add-user').on('click', function () {
                ...
                if (bannerTitle === "" || bannerTitle === null || bannerDesc === "" || bannerDesc === null || file === "" || file === null ) {
        ...
        $(function () {
            $('.edit-user').on('click', function () {
                ...
                $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: "xhr/edit-banner.php",
                    data: { bannerID: bannerID },
                    success: function (response) {
                        $("#editName").html(response.bannerTitle);
                        $("#edit_banner_title").val(response.bannerTitle);
                        $("#edit_banner_desc").val(response.bannerDesc);
                       
                        //  $("#edit_email").val(response.email);
                        //  $("#edit_phone").val(response.phone);
                        $("#edit_banner_id").val(response.bannerID);
        ...
        $(function () {
            $('#update-banner').on('click', function () {
                var bannerTitle = $("#edit_banner_title").val();
                var bannerDescription = $("#edit_banner_desc").val();
               
                var bannerId = $("#edit_banner_id").val();
                ...
                if (bannerTitle === "" || bannerTitle === null || bannerDescription === "" || bannerDescription === null ) {
