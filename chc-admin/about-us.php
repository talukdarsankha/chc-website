                    ...
                    <div class="card">
                        <div class="header">
                            <a class="btn btn-primary" href="javascript:void(0);" data-toggle="modal"
                                data-target="#defaultModal">Add About</a>
                        </div>
                        <div class="header ">
                            <h2>
                                ABOUT
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right js-sweetalert">
                                        <li><a href="javascript:void(0);" data-toggle="modal"
                                                data-target="#defaultModal">Add About</a></li>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        <?php $readSermons = $crud->Read('about',"1 order by `about_id` desc");  
                                        if ($readSermons) {
                                            $n=0;
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo $readKey['about_intro']; ?>
                                            </td>
                                            <td>
                                                <?php echo $readKey['about_title']; ?>
                                            </td>
                                            <td>
                                                <p style="width: 250px;"><?php echo $readKey['about_desc']; ?></p>
                                            </td>
                                            <td><img src="<?php echo $readKey['about_img']; ?>" width="120px"
                                                    height="100px"></td>
                                           
                                            <td>
                                                <p style="width: 160px; overflow-x: scroll;"><?php echo $readKey['about_link']; ?></p>
                                            </td>
                                            <td><button id="edit-user" data-toggle="modal" data-target="#editModal"
                                                    data-id="<?php echo $readKey['about_id']; ?>" type="button"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">Add About</h4>
                </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="about_intro" id="about_intro" class="form-control"
...
<!--                                 
                                ...
                                <div class="form-floating " style="margin-bottom: 20px;">
                                    <label for="floatingTextarea2">About Descprition</label>
                                    <textarea class="form-control" name="about_desc" id="about_desc" placeholder="Leave a descprition here" style="height: 100px" required></textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="about_link" id="about_link" class="form-control"
                                            placeholder="About Link" style="color: blue;" autofocus="false"  /> 
                                    </div>
                                </div>
                    ...
                    <div class="modal-footer ">
                        ...
                        <input type="button" id="add-user" onclick="addUser(this);" class="btn btn-success waves-effect"
                            value="Add About" data-type="success">
            ...
            <div class="modal-content">
                ...
                <form method="post" enctype="multipart/form-data" action="">
                    <div class="modal-body">
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="edit_intro" class="form-control"
                                            placeholder="About Intro" autofocus="false" required />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="edit_title" class="form-control"
                                            placeholder="About Title" autofocus="false" required />
                                    </div>
                                </div>
                                ...
                                <!-- Sermon Description Textarea start -->
                                <div class="form-floating " style="margin-bottom: 20px;">
                                    <label for="floatingTextarea2">About's Descprition</label>
                                    <textarea class="form-control" id="edit_desc" placeholder="Leave a descprition here" style="height: 100px" ></textarea>
                                </div>
                                <!-- Sermon Description Textarea end -->
                    ...
                    <div class="modal-footer ">
                        ...
                        <!-- use ajax to add user: xhr/add-user -->
                        <input type="button" id="update-about" class="btn btn-success waves-effect"
                            value="Update about">
                        <input type="button" id="delete-about" class="btn btn-danger waves-effect"
                            value="Delete about">
                    </div>
    ...
    <script>
        $(function () {
            $('#add-user').on('click', function () {
                ...
                var aboutIntro = $("#about_intro").val();
                var aboutTitle = $("#about_title").val();   
                var aboutDesc = $("#about_desc").val(); 
                var aboutLink = $("#about_link").val(); 
                ...
                formData.append('aboutIntro', aboutIntro); 
                formData.append('aboutTitle', aboutTitle);
                formData.append('aboutDesc', aboutDesc); 
                formData.append('aboutLink', aboutLink);


                if (aboutIntro === "" || aboutIntro === null || aboutTitle === "" || aboutTitle === null || aboutDesc === "" || aboutDesc === null || file === "" || file === null) {
        ...
        $(function () {
            $('.edit-user').on('click', function () {
                ...
                $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: "xhr/edit-about.php",
                    data: { aboutId: aboutId }, 
                    success: function (response) {   
                        $("#editName").html(response.aboutIntro);

                        $("#edit_intro").val(response.aboutIntro);
                        $("#edit_title").val(response.aboutTitle);
                        $("#edit_desc").val(response.aboutDesc); 
                        $("#edit_link").val(response.aboutLink);
                       
                        //  $("#edit_email").val(response.email);
                        //  $("#edit_phone").val(response.phone);
                        $("#edit_about_id").val(response.aboutId);
        ...
        $(function () {
            $('#update-about').on('click', function () {
                var  aboutIntro= $("#edit_intro").val();
                var aboutTitle = $("#edit_title").val();
                var aboutDesc = $("#edit_desc").val();
                var aboutId = $("#edit_about_id").val(); 
                var aboutLink = $("#edit_link").val(); 
                ...
                if (aboutIntro === "" || aboutIntro === null || aboutTitle === "" || aboutTitle === null || aboutDesc === "" || aboutDesc === null) {
        ...
        $(function () {
            $('#delete-about').on('click', function () {
