  ...
  <div id="itemList">
    <div class="imcontainer">
      ...
      <div class="gallery">
        ...
        <a href="galleryDetails.php?gallery_id=<?php echo $gallerykey["gallery_id"]; ?>">
        ...
        <div class="card-body item">
          ...
          <h5 class="card-title mt-3">
            <?php 
            $galleryTitle= $gallerykey["img_title"];
            if(strlen($galleryTitle)>15){
              echo substr($galleryTitle,0,15)."..";
            }else{
              echo $galleryTitle;
            }
            ?>
          ...
          <?php
            ...
            if($poster){
          ?>
          <i class="text-right" style="color:#f75023; font-size: small;">Posted by : <b><?php echo $poster[0]["name"]; ?></b> </i>
          <p class="card-text" style="background: rgb(243, 243, 243);padding: 10px;border-radius: 9px; min-height: 120px;">
            <?php 
...
<style>
   ...
   .gallery img:hover{
    ...
    /* @media screen and (min-device-width: 340px) and (max-device-width: 596px) { 
      .gallery .card-body {
    width: 550px;
    }
    } */
